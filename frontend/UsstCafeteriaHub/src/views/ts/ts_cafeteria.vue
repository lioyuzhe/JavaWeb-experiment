  ...
  <div>
    ...
    <div class="top-container">
      ...
      <div class="cafeteria-select">
        ...
        <el-button style="width: 100px;">四食堂</el-button>
        <!-- 更多按钮 -->
    ...
    <div class="main-layout">
      <!-- 侧边栏 -->
      <el-menu class="el-menu-vertical-demo" style="width: 100%;" default-active="1">
        <el-menu-item index="1">食堂介绍</el-menu-item>
        <el-menu-item index="2">菜品</el-menu-item>
        <el-menu-item index="3">投票</el-menu-item>
...
.cafeteria-search {
  flex: 0 1 50%; /* 设置基础宽度为50%，并允许收缩但不伸展 */
  margin-right: 10px;
}
