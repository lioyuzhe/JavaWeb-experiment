...
<!--      </el-upload>-->
    ...
    <el-table :data="tableData" stripe :header-cell-style="{ backgroundColor: 'aliceblue', color: '#666' }" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="userId" label="序号" width="70" align="center"></el-table-column>
...
<!--      <el-table-column prop="address" label="地址"></el-table-column>-->
      ...
      <el-table-column prop="activityLevel" label="活跃度" width="180" align="center"></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="fromVisible" width="30%">
      <el-form :model="form" label-width="80px" style="padding-right: 20px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="活跃度" prop="activityLevel">
          <el-input v-model="form.activityLevel" placeholder="活跃度"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    getUsers () {
      this.$request.get('/admins/actions/getUsers').then(res => {
    ...
    save() {   // 保存按钮触发的逻辑  它会触发新增或者更新
      this.$refs.formRef.validate((valid) => {
        if (valid) {
          this.$request({
            url: this.form.userId ? '/admins/actions/updateUser': '/admins/actions/addUser',
            method: 'POST',
            data: this.form
          }).then(res => {
    ...
    load(pageNum) {  // 分页查询
      ...
      this.$request.get('/admins/actions/selectByPage', {
        params: {
